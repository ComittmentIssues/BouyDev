...
#include <string.h>
#include <math.h>
char* payload ="015d15c4c4d0bcb2c36d77e444031b02a0015b1b1da5034a0000";
...
int main()
{
    ...
    payload+=2;
    uint8_t num_sats = (signal&0b11110000)>>4;
    uint8_t signal_type = (signal&0b1100)>>2;
    ...
    printf("Number of Satelites = %d Signal type = %d",num_sats,signal_type);
    printf("Ambient Temperature: %0.2f°C ",v_bat);
    printf("Battery Voltage: %0.2fV",temp);
