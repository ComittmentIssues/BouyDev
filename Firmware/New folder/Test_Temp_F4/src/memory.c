...
char write_to_memory(FATFS *fs,FIL *fp,FRESULT err,const TCHAR *path,UINT *bw,const TCHAR *data,UINT data_length,FLAG *f)
{
	char memory_status = 0;//
